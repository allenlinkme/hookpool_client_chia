...
感谢矿工朋友们的信任与支持，但是我们碰到一些问题，还请矿工朋友们暂时不要接入。

由于CHIA官方的程序集群挖矿性能极低，严重低于常规互联网产品的性能标准与支撑量级(甚至不到十分之一)，并且存在严重性能缺陷导致不可长期运行。

作为非商业化矿池，我们不能通过高昂的硬件成本与人力成本进行支撑。

很遗憾告诉所有矿工朋友，请给我们一些时间，我们正在积极解决这一问题。
